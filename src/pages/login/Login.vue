<template>
  <div class="container" :class="{ 'sign-up-mode': !isSignIn }">
    ...
    <div class="panels-container">
      <div class="panel left-panel">
        <div class="content">
          ...
          <button class="btn transparent" @click="handleSignUp">注册</button>
        </div>
      </div>
      <div class="panel right-panel">
        <div class="content">
          ...
          <button class="btn transparent" @click="handleSignIn">Sign in</button>
        </div>
      </div>
    </div>
    <div>
